// QuoteForm.tsx (Solution)
// The form logic now lives in the useQuoteEstimate hook. Saving a quote
// dispatches into context via addQuote — no props passed for the saved list.
