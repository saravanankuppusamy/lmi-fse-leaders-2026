// Evergreen Insurance — Week 5 solution script
// Identical to the Week 4 starter except: the `auto` rate in
// `ratePerThousand` was nudged from 1.2 to 1.5 after running the
// lab's "set a breakpoint, step through, and adjust one value"
// workflow. See evergreen-quote-rate-tweak.adoc.
